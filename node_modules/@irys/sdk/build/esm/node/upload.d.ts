...
import type { CreateAndUploadOptions, Token, IrysTransactonCtor, UploadReceipt, UploadResponse } from "../common/types.js";
...
export default class NodeUploader extends Uploader {
     ...
     */
    generateManifestFromCsv(path: string, nowRemoved?: Map<string, true>, indexFile?: string): Promise<string>;
}
